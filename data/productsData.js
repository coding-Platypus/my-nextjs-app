export const fallbackProducts = [
  ...
  },
  {
    ...
    price: 999.99,
    description: "49 INCH SUPER ULTRAWIDE 32:9 CURVED GAMING MONITOR with dual 27 inch screen side by side QUANTUM DOT (QLED) TECHNOLOGY, HDR support and 144Hz high refresh rate.",
    category: "electronics",
  ...
  },
  {
    ...
    price: 56.99,
    description: "Stand Collar Liner jacket, keep you warm in cold weather. Adjustable and Detachable Hood and Adjustable cuff to prevent the wind and water, for a comfortable fit.",
  ...
  },
  {
    ...
    price: 29.95,
    description: "Faux leather material for style and comfort / 2 pockets of front, 2-For-One Hooded denim style faux leather jacket, Button detail on waist.",
    category: "women's clothing",
  ...
  },
  {
    ...
    price: 12.99,
    description: "95% Cotton, 5% Spandex, Casual, Short Sleeve, Letter Print, V-Neck, Fashion Tees, The fabric is soft and has some stretch.",
    category: "women's clothing",
